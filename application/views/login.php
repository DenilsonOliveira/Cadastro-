  ...
  <div class="row">
    <div class="span4">
      <div class="alert alert-info">
        <p><strong>Você</strong> Não esta Logado!</p>
        <small>Não tem conta? </small>
        <a href="<?=site_url('registrar'); ?>" class="btn btn-info"><i class="icon-arrow-right icon-white"></i> Resistrar-Se</a>
      </div>
    </div>
  </div>
  <? endif; ?>
