  ...
  <div class="navbar-inner">
    <div class="container">
      ...
      <ul class="nav">
        ...
        <li id="nav-add"><?=anchor('admin/Adicionar', 'Adicionar'); ?></li>
        <li class="divider-vertical"></li>
        <li id="nav-delete"><?=anchor('admin/delete', 'Delete'); ?></li>
        <li class="divider-vertical"></li>
        <li id="nav-edit"><?=anchor('admin/Editar', 'Editar'); ?></li>
        <li class="divider-vertical"></li>
      </ul>
      <div class="pull-right">
        <small class="navbar-text">Admin: <?=anchor('admin/profile', $this->session->userdata('admin')); ?> </small>
        <a href="<?=site_url('adminlogin/logout'); ?>" class="btn btn-primary"><i class="icon-road icon-white"></i> Sair</a>
      </div>
    </div>
  </div>
</div>
