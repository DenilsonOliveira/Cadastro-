  ...
  <div class="row">
    <div class="span4">
      <form id="formAdd" class="well" accept-charset="utf-8">
        ...
        <input type="endereco" name="endereco" class="input-block-level" placeholder="endereco" required maxlength="15" />
        <input type="modelo" name="modelo" class="input-block-level" placeholder="modelo" required maxlength="15" />
        <input type="entrada" name="entrada" class="input-block-level" placeholder="entrada" required maxlength="15" />
        <input type="data" name="data" class="input-block-level" placeholder="data" required maxlength="15" />
        <input type="text" name="phone" class="input-block-level" placeholder="Phone" required maxlength="15" />
        <button type="submit" class="btn btn-success btn-large">
        <i class="icon-plus icon-white"></i> Adicionar Clientes</button>
      </form>
    </div>
  </div>
